...
The V2 server checkpoints survivor positions, inventories, shared container state, and zombies every five seconds and when players disconnect. Local save data is written to `apps/server/data/worlds.json` and is excluded from Git.
...
The technical direction, BiomeGen model, persistence strategy, delivery phases, and first vertical-slice definition are documented in [docs/V2_ARCHITECTURE.md](docs/V2_ARCHITECTURE.md).
